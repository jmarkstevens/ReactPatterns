...
class AppCtrl extends React.Component {
  ...
  componentDidMount() {
    let _this = this;
    window.setTimeout(() => _this.setMarkers(_this), 5000);
  }
  setMarkers = _this => {
  ...
  render() {
    ...
    let hideLogin = page != 'login';
    let hideDashboard = page != 'dashboard';
    let hideSetup = page != 'setup';
    let hideSupport = page != 'support';
    let hideSwitchboard = page != 'switchboard';
    return (
