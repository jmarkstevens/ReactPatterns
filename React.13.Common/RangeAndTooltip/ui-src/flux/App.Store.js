...
var _filterList = {
	...
	height: { value: {more: 1, less: 85}, options: {}},
	width: { value: {more: 1, less: 30}, options: {}},
...
function _setFilterValues() {
	...
	_filterList.height.value.less = 85;
	_filterList.height.value.more = 1;
	_filterList.width.value.less = 30;
	_filterList.width.value.more = 1;
...
function _changeFilterValue(itemName, value) {
	switch (itemName) {
		case 'lowtemp': _filterList.lowtemp.value = value; break;
		case 'leaftype': _filterList.leaftype.value = value; break;
		case 'heightLess': _filterList.height.value.less = value; break;
		case 'heightMore': _filterList.height.value.more = value; break;
		case 'widthLess': _filterList.width.value.less = value; break;
		case 'widthMore': _filterList.width.value.more = value; break;
