...
export default class JProgressBar extends React.Component {
  render() {
    ...
    let countSty = this.props.countSty ? Object.assign({}, this.props.countSty) : Object.assign({}, defaultCountSty);
    let indexSty = this.props.indexSty ? Object.assign({}, this.props.indexSty) : Object.assign({}, defaultIndexSty);
